...
Report bugs at https://github.com/raman4793/click-lite/issues
...
https://github.com/raman4793/click-lite/issues.
...
Ready to contribute? Here's how to set up `click-lite` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `click-lite` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/click-lite.git
